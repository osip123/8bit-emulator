...
var lodash_1 = __webpack_require__(/*! lodash */ "./node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/lodash.js");
var registers_1 = __webpack_require__(/*! ./registers */ "./src/cpu/registers.ts");
var instProgramCounterStackControl_1 = __webpack_require__(/*! ../instrucrion/instProgramCounterStackControl */ "./src/instrucrion/instProgramCounterStackControl.ts");
var CPU = /** @class */ (function () {
    function CPU(registes) {
        this.registers = registes;
    }
    CPU.prototype.cmdList = function () {
        for (var i = 0; i < registers_1.register.length; i++) {
            if (this.registers[i].type === registers_1.registersCode.A) {
                this.cmds[0] = "00000000";
            }
            if (this.registers[i].type === registers_1.registersCode.B) {
                this.cmds[1] = this.registers[i].read();
            }
            if (this.registers[i].type === registers_1.registersCode.C) {
                this.cmds[2] = this.registers[i].read();
            }
            if (this.registers[i].type === registers_1.registersCode.D) {
                this.cmds[3] = this.registers[i].read();
            }
            if (this.registers[i].type === registers_1.registersCode.E) {
                this.cmds[4] = this.registers[i].read();
            }
            if (this.registers[i].type === registers_1.registersCode.H) {
                this.cmds[5] = this.registers[i].read();
            }
            if (this.registers[i].type === registers_1.registersCode.L) {
                this.cmds[6] = this.registers[i].read();
            }
        }
    };
    CPU.prototype.decode = function (cmd) {
        switch (cmd) {
            case "0001":
                return "PUSH";
                break;
    ...
    CPU.prototype.execute = function (cmd) {
        console.log(this.registers[1].read());
        var decoded_cmd = this.decode(this.registers[1].read());
        console.log(decoded_cmd);
        this.run(decoded_cmd, cmd);
    };
    CPU.prototype.run = function (dc, cmd) {
        switch (dc) {
            case "PUSH":
                var addr = (0, lodash_1.toInteger)(cmd[1]);
                console.log(addr);
                (0, instProgramCounterStackControl_1.PUSH)(addr, this.registers, cmd[2]);
                break;
        }
    };
    return CPU;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.regiderAdresses = void 0;
exports.getRegisterValue = getRegisterValue;
exports["default"] = getRegisterIndex;
function getRegisterValue(addr, regList) {
    // switch(addr) {
    //     case 0x01:
...
function getRegisterIndex(addr) {
    switch (addr) {
        case 0x01:
            return 0;
        case 0x02:
...
/***/ "./src/instrucrion/instProgramCounterStackControl.ts":
/*!***********************************************************!*\
  !*** ./src/instrucrion/instProgramCounterStackControl.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.JMP = JMP;
exports.PUSH = PUSH;
var registersutiles_1 = __webpack_require__(/*! ../cpu/registersutiles */ "./src/cpu/registersutiles.ts");
function JMP(addr, registers) {
}
function PUSH(addr, registers, value) {
    var index = (0, registersutiles_1.default)(addr);
...
var cpu_1 = __webpack_require__(/*! ./cpu/cpu */ "./src/cpu/cpu.ts");
function main() {
    ...
    var cpu = new cpu_1.default(registers);
